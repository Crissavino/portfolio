            ...
            <div class="col-md-12 col-md-offset-0">
                <ul class="timeline">
                    ...
                    <li class="timeline-inverted animate-box">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                ...
                                <span class="company"><a target="_blank"
                                                         href="https://padelmanager.com">Padelmanager</a> - DECEMBER 2019 - NOVEMBER 2020</span>
                            </div>
                            <div class="timeline-body">
                                <p>● I was responsible for supporting the platform that is already in use, both for the
                                    web and mobile API.</p>
                                <p>● I was in charge of making the deployments in production at the end of the
                                    Sprints.</p>
                    ...
                    <li class="timeline-inverted animate-box">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h3 class="timeline-title">Professor</h3>
                                <span class="company">
                                    <a target="_blank" href="https://logiscool.com">Logiscool</a> - OCTOBER 2019 - FEBRUARY 2020
                                </span>
                            </div>
                            <div class="timeline-body">
                                <p>● I was teaching a block programming course to a group of children in which the objective was to make web games.</p>
                                <p>● Every week I prepare each class so that the children can go home with the game finished.</p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="animate-box timeline-unverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h3 class="timeline-title">Flutter: Your complete development guide for iOS and Android</h3>
                                <span class="company"><a target="_blank" href="https://udemy.com">Udemy</a> - JUNE 2020</span>
                            </div>
                            <div class="timeline-body">
                            </div>
                        </div>
